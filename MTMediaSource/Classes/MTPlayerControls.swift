...
extension MTPlayerControls {
    ...
    @objc open func slide(to value: Float) {
...
extension MTPlayerControls {
    @objc open func configureUI() {
        ...
        let topH = safeAreaInsets.top > 0 ? mt_baseline(44) : mt_baseline(64)
    ...
    public func toggleShowLockedViews(_ isShow: Bool) {
    ...
    public func showTimeTips(_ toTime: Int) {
    ...
    public func showAccelerateTips() {
        tipsContainerView.isHidden = false
        accelerateTipsView.isHidden = false
    }

    public func showVolumeTips(_ text: String) {
        volumeTipsView.titleNormal = text
        volumeTipsView.isHidden = false
        tipsContainerView.isHidden = false
    }

    public func showBrightnessTips(_ text: String) {
